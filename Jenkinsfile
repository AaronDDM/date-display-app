...
podTemplate(label: label, containers: [
  ...
  containerTemplate(name: 'kubectl', image: 'lachlanevenson/k8s-kubectl:v1.8.8', command: 'cat', ttyEnabled: true, namespace: 'jenkins-team3', serviceAccount: 'jenkins-team3'),
